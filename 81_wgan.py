...
PLT_SAVE_FILE = 'chessboard\\wgan\\0907_add_loss_wgan'
...
def generator_model():
    ...
    model.add(tf.keras.layers.Dense(1024,  use_bias=False))      # (n, 400)
    ...
    model.add(tf.keras.layers.Dense(30 * 81 , use_bias=False))    # (n, 36)
    model.add(tf.keras.layers.BatchNormalization())
